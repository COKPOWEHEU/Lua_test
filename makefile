...
spec_cflags +=	$(_flagdiv_)arch_win32 -I./mingw
spec_cflags +=	$(_flagdiv_)arch_win64
		
spec_ldflags  =	$(_flagdiv_)arch_lin32 -m32 -B/usr/lib/gcc/i686-linux-gnu/6 -lGL -lGLU -llua5.2
spec_ldflags +=	$(_flagdiv_)arch_lin64 -lGL -lGLU -llua5.2
spec_ldflags +=	$(_flagdiv_)arch_win32 -static-libgcc -static-libstdc++ -lmingw32 -lSDL2main -lopengl32 -lglu32 -lgdi32 -mconsole -mwindows -lmingw32 -lSDL2main -lSDL2 -mwindows -lSDL2.dll -L./mingw -llua52
